      ...
      >
        <div className="p-2">
          <div className="flex flex-col gap-6">
            ...
            <div>Payment</div>
            <InputBox id="creditCardNumber" Name="Credit Card Number" />
            <InputBox id="cardHolderName" Name="Card Holder Name" />
            <InputBox id="cardExpirationDate" Name="Card Expiration Date" />
